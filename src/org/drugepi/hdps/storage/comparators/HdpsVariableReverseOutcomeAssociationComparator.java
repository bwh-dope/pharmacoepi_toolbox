...
public class HdpsVariableReverseOutcomeAssociationComparator extends HdpsVariableRankingComparator
{
	public int compare(HdpsVariable var1, HdpsVariable var2)
	{
		double v1 = var1.outcomeAssocRankingVariable;
		double v2 = var2.outcomeAssocRankingVariable;
